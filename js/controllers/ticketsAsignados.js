...
const filtrosWrapper = document.querySelectorAll(".filter-wrapper");//Para los paneles de filtros
...
document.addEventListener("DOMContentLoaded", () => {
    cargarTicketsAsignados(idUsuario);
...
async function cargarTicketsAsignados(idUsuario, pagina = 1) {
    ...
    try {
        ...
        if (!tickets || tickets.length === 0) {
            ticketsStack.innerHTML = `<div class="justify-content-center text-center">
                <p class="text-muted justify-content-center">No se encontraron tickets asignados.</p> 
